        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please fill this form and submit to add patients record in the database.</p>
                    <form action="../index.php?act=update" method="post">
                        ...
                        <div class="form-group form-check">
                            ...
                            <input type="checkbox" class="form-check-input" id="referred" name="referred"
                                value="<?= ($sporttb->referred == "referred") ? '0' : '1'; ?>"
                                <?= ($sporttb->referred == "referred") ? 'checked' : ''; ?> />
